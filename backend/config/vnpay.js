const vnpayConfig = {
  ...
  vnp_ReturnUrl: process.env.BACKEND_URL ? `${process.env.BACKEND_URL}/api/payment/vnpay-return` : 'http://localhost:3001/api/payment/vnpay-return',
  vnp_IpnUrl: process.env.BACKEND_URL ? `${process.env.BACKEND_URL}/api/payment/vnpay-ipn` : 'http://localhost:3001/api/payment/vnpay-ipn',
  vnp_Version: '2.0.0',
  vnp_Command: 'pay',
  vnp_CurrCode: 'VND',
  vnp_Locale: 'vn',
