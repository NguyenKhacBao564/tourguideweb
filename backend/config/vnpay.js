const vnpayConfig = {
  ...
  vnp_ReturnUrl: 'http://100.90.83.88:3001/api/payment/vnpay-return', // URL return về backend để xử lý
  vnp_IpnUrl: 'http://100.90.83.88:3001/api/payment/vnpay-ipn', // URL IPN callback
  vnp_Version: '2.0.0',
  vnp_Command: 'pay',
  vnp_CurrCode: 'VND',
  vnp_Locale: 'vn',
